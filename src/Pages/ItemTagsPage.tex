    ...
    \begin{Tables}{\backTableHeight}%
        \begin{Table}{Traits: Weapon}
            ...
            \begin{entry}{}{%
                ...
                \D{Bipod, tripoid, or stabalize can reduce/negate penalty.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Modular,
            ...
            \begin{entry}{}{%
                ...
                \D{If you have negative modifer add full instead.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\RangedTrip,
            ...
            \begin{entry}{}{%
                ...
                Channel energy into weapon after spell cast with \Refer{Acid}, \Refer{Cold}, \Refer{electricy}, \Refer{fire} or \Refer{Sonic} trait: \\
            ...
            \begin{entry}{}{%
                ...
                If a attack weapon with the splash trait doesn't \CFC{Criticaly miss} then all creatures within \Numb{5} \Feet\,(and target) takes the listed splash damage.
            ...
            \begin{entry}{}{%
                ...
                \D{\Refer{Disarmed} by knocking the crontols out of wielder's hands.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Versatile,
    ...
    \begin{Tables}{\backTableHeight}%
        ...
        \begin{Table}{Traits: Armour}
            ...
            \begin{entry}{}{%
                ...
                \D{Seperate and additional to armor's \Refer{Speed Penalty}.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Inscribed,
        ...
        \begin{Table}{Traits: Shield}
            ...
            \begin{entry}{}{%
                ...
                While \Refer{Raised} you gain the jousing benefit as if mounted.
