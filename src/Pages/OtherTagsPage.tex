    ...
    \begin{Tables}{\frontTableHeight}
        \begin{Table}{Traits: Actions}
            ...
            \begin{entry}{}{%
                ...
                \D{Effecs that are added on a \FC{failure} don't apply on a \CFC{CF}. \hfill
                If your action \SC{succeds} you can choose to apply the \FC{failure} effect instead.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                page=460,
        ...
        \begin{Table}{Traits: Afflictions }[{\scalefont{0.8}(\MSC{Poisons}, \MSC{Drugs}, \MSC{Diseases and Curses})}]
            ...
            \begin{entry}{}{%
                ...
                \D{If \CFC{CF} or hit fails to deal \Type{Piercing} or \Type{Slashing} damage the poision isn't applied.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Poison,
                ...
                See \Refer{Treat Posison} for removing.
            \end{entry}
            \begin{entry}{}{%
                align=center seam,
                name width=\conditionLength,%
            ...
            \begin{entry}{}{%
                ...
                See Spell \Refer{Clense Affliction} or \Refer{Break Curse} skill feat for removing.
            \end{entry}
        \end{Table}
        \TableSpace
    ...
    \begin{Tables}{\frontTableHeight}
        ...
        \begin{Table}{Traits: Magical}
            ...
            \begin{entry}{}{%
                ...
                \D{Targets item bonuses apply to physical and possesors apply to mental.}\\
        ...
        \begin{Table}{Traits: Misc Items}
            \begin{entry}{}{%
                ...
                \D{Armor adjustments can't alter \Refer{Explorers clothing}.}\\
                A equipment can only be affected by a single adjustment. \hfill
                \D{Appying usually takes \TimeMin{10} and a \Refer{Repair Kit}.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Companion,
            ...
            \begin{entry}{}{%
                ...
                \D{You can allways disable your own snare.}
            \end{entry}
            \begin{entry}{}{%
                name width=\conditionLength,%
                action=\Precious,
