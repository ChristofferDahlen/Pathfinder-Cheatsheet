    ...
    \begin{Tables}{\frontTableHeight}
        ...
        \begin{Table}{Conditions: Physical}
            ...
            \begin{entry}{Drained}{%
                ...
                \Numb{-\X} \Status penalty to \Constitution based checks. Lose \Numb{\X\Times \Level} \HPs and
        ...
        \begin{Table}{Conditions: Death and Dying}
            ...
            \begin{entry}{Dying}{%
                ...
                at \Numb{4} (dying value). \hfill  Lose if \Numb{\HPs > 0}. \hfill \D{You are \Unconscious.} \\
            ...
            \begin{entry}{Wounded}{%
                ...
                You are injured. If you lose the \Dying condition increase by \Numb{1}.
    ...
    \begin{Tables}{\frontTableHeight}
        \begin{Table}{Conditions: Health}
            ...
            \begin{entry}{Petrified}{%
                ...
                You can't act or sense. You become an \textbf{object} with a \Bulk double your normal \Bulk, \Ac\,\Numb{9}, \Hardness\,\Numb{8} \HPs as Alive.\\
        ...
        \begin{Table}{Rules reminders}
            ...
            \begin{entry}{}{%
                ...
                the end of
                your turn.
                By \Numb{2} if attack or cast a spell. Lose \Numb{1} round if critical hit/fail.}\\
                No air: Fall \Type{Unconcous} and at end of each turn make \Fortitude[][val=20] \F{Take
                \Numb{1d10}%
                damage} \CF{die.}\hfill  \D{Lose all air if you speak (including \Refer{Casting a Spell}).}\\
