...
\newcommand{\pgRotate}[1]{{\BodyFont\scalefont{0.6}\baselineskip=0pt\adjustbox{stack = cb,rotate=90}{\textcolor{PGColor}{#1}}}}
...
\newcommand{\Numb}[1]{{\kirsty\scalefont{0.9}#1}}
\newcommand{\DCNumb}[1]{{\kirsty\scalefont{0.7}#1}}


\NewDocumentCommand{\Type}{m O{0.9}}{{\kirsty\scalefont{#2}\MSC{#1}}\xspace}
\NewDocumentCommand{\Typet}{m O{0.9}}{{\kirsty\scalefont{#2}#1}\xspace}
\NewDocumentCommand{\Typetv}{m O{0.9}}{{\kirsty\scalefont{#2}#1}}


\newcommand{\Condition}[1]{{\kirsty\scalefont{0.8}\MSC{#1}}\xspace}


\newcommand{\T}{{\rmfamily\scalefont{1.1}\IBox{T}}}
\newcommand{\Ts}{{\rmfamily\scalefont{1.1}\IBox[1]{T}}}
\newcommand{\E}{{\rmfamily\scalefont{1.1}\IBox[0.9]{E}}}
\newcommand{\M}{{\rmfamily\scalefont{1.1}\IBox[0.9]{M}}}
\newcommand{\Le}{{\rmfamily\scalefont{1.1}\IBox[0.9]{L}}}
\newcommand{\Se}{{\rmfamily\scalefont{1.1}\IBox{S}}}
\newcommand{\Reck}{{\rmfamily\scalefont{1.1}\IBox{R}}}
...
\NewDocumentCommand{\entry}{m m O{}}{%
    ...
    \begin{tcolorbox}[enhanced,sharp corners,
        ...
        \begin{minipage}[c][][c]{\entry@namewidth\linewidth}%
            \ActionSize%
            {\BodyFont\scalefont{\entry@namescale}%
...
\def\Serif{\rmfamily}
\def\SanSerif{\sffamily\scalefont{0.5}}
